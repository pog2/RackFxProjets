...
*/
CStereoQuadFlanger::CStereoQuadFlanger()
{
	...
	m_PlugInName = "StereoQuadFlanger";
...
// updateModDelays : update all param
/*
	...
	- mod type = 0 = flanger
	- LFO type
	- call the update() function to cook everything
*/
void CStereoQuadFlanger::updateModDelays()
{
	//setup quad phase
	m_ModDelayLeft.m_uLFOPhase = 0; //normal
	m_ModDelayRight.m_uLFOPhase = 1; //quadratic
...
*/
CStereoQuadFlanger::~CStereoQuadFlanger(void)
{
...
*/
bool __stdcall CStereoQuadFlanger::initialize()
{
	// Add your code here
...
processRackAFXMessage()
	...
	See the website www.willpirkle.com for more details
*/
void __stdcall CStereoQuadFlanger::processRackAFXMessage(UINT uMessage, PROCESS_INFO& processInfo)
{
...
*/
bool __stdcall CStereoQuadFlanger::processAudioFrame(float* pInputBuffer, float* pOutputBuffer, UINT uNumInputChannels, UINT uNumOutputChannels)
{
	...
	if(uNumInputChannels == 2 && uNumOutputChannels == 2)
		m_ModDelayRight.processAudioFrame(&pInputBuffer[1], &pOutputBuffer[1], 1, 1);
	return true;
}
...
bool __stdcall CStereoQuadFlanger::checkUpdateGUI(int nControlIndex, float fValue, CLinkedList<GUI_PARAMETER>& guiParameters, bool bLoadingPreset)
{
...
bool __stdcall CStereoQuadFlanger::processAuxInputBus(audioProcessData* pAudioProcessData)
{
...
*/
bool __stdcall CStereoQuadFlanger::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD, float fACMix, float fBDMix)
{
	// add your code here
...
/* processAudioBuffer
	...
	******************************
	...
	m_HostProcessInfo.uTimeSigDenomintor = Host Time Signature Denominator (if supported by host)
*/
bool __stdcall CStereoQuadFlanger::processRackAFXAudioBuffer(float* pInputBuffer, float* pOutputBuffer,
...
*/
bool __stdcall CStereoQuadFlanger::processVSTAudioBuffer(float** inBuffer, float** outBuffer, UINT uNumChannels, int inFramesToProcess)
{
...
bool __stdcall CStereoQuadFlanger::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity)
{
	return true;
}

bool __stdcall CStereoQuadFlanger::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff)
{
	return true;
}

// uModValue = 0->127
bool __stdcall CStereoQuadFlanger::midiModWheel(UINT uChannel, UINT uModValue)
{
	return true;
}
...
bool __stdcall CStereoQuadFlanger::midiPitchBend(UINT uChannel, int nActualPitchBendValue, float fNormalizedPitchBendValue)
{
	return true;
}
...
*/
bool __stdcall CStereoQuadFlanger::midiClock()
{
...
bool __stdcall CStereoQuadFlanger::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
*/
void CStereoQuadFlanger::doVSTSampleAccurateParamUpdates()
{
...
void* __stdcall CStereoQuadFlanger::showGUI(void* pInfo)
{
...
bool __stdcall CStereoQuadFlanger::initUI()
{
	// ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! -------------------------------------- //
...
// **--0xDEA7--**
	...
	ui3->m_pUserCookedUINTData = &m_uLFOType;
	ui3->cControlUnits = "";
	ui3->cVariableName = "m_uLFOType";
	ui3->cEnumeratedList = "tri,sin";
