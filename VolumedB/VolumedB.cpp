...
*/
bool __stdcall CVolumedB::initialize()
{
	// Add your code here
...
processRackAFXMessage()
	...
	See the website www.willpirkle.com for more details
*/
void __stdcall CVolumedB::processRackAFXMessage(UINT uMessage, PROCESS_INFO& processInfo)
{
...
*/
bool __stdcall CVolumedB::prepareForPlay()
{
	// Add your code here:
...
bool __stdcall CVolumedB::checkUpdateGUI(int nControlIndex, float fValue, CLinkedList<GUI_PARAMETER>& guiParameters, bool bLoadingPreset)
{
...
bool __stdcall CVolumedB::processAuxInputBus(audioProcessData* pAudioProcessData)
{
...
*/
bool __stdcall CVolumedB::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD, float fACMix, float fBDMix)
{
	// add your code here
...
/* processAudioBuffer
	...
	******************************
	...
	m_HostProcessInfo.uTimeSigDenomintor = Host Time Signature Denominator (if supported by host)
*/
bool __stdcall CVolumedB::processRackAFXAudioBuffer(float* pInputBuffer, float* pOutputBuffer,
...
*/
bool __stdcall CVolumedB::processVSTAudioBuffer(float** inBuffer, float** outBuffer, UINT uNumChannels, int inFramesToProcess)
{
...
bool __stdcall CVolumedB::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity)
{
	return true;
}

bool __stdcall CVolumedB::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff)
{
	return true;
}

// uModValue = 0->127
bool __stdcall CVolumedB::midiModWheel(UINT uChannel, UINT uModValue)
{
	return true;
}
...
bool __stdcall CVolumedB::midiPitchBend(UINT uChannel, int nActualPitchBendValue, float fNormalizedPitchBendValue)
{
	return true;
}
...
*/
bool __stdcall CVolumedB::midiClock()
{
...
bool __stdcall CVolumedB::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
*/
void CVolumedB::doVSTSampleAccurateParamUpdates()
{
...
void* __stdcall CVolumedB::showGUI(void* pInfo)
{
...
bool __stdcall CVolumedB::initUI()
{
	// ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! -------------------------------------- //
