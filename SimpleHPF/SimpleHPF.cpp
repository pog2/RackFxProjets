...
*/
bool __stdcall CSimpleHPF::initialize()
{
	// Add your code here
...
processRackAFXMessage()
	...
	See the website www.willpirkle.com for more details
*/
void __stdcall CSimpleHPF::processRackAFXMessage(UINT uMessage, PROCESS_INFO& processInfo)
{
...
*/
bool __stdcall CSimpleHPF::processAudioFrame(float* pInputBuffer, float* pOutputBuffer, UINT uNumInputChannels, UINT uNumOutputChannels)
{
	...
	if(uNumInputChannels == 2 && uNumOutputChannels == 2)
		...
		//Read x(n-1)
		xn_1 = m_f_z1_right;
		yn = m_f_a0_right*xn + m_f_a1_right*xn_1;
		//Stockage de la nouvelle valeur
		m_f_z1_right = xn;
		pOutputBuffer[1] = yn;
	return true;
...
bool __stdcall CSimpleHPF::checkUpdateGUI(int nControlIndex, float fValue, CLinkedList<GUI_PARAMETER>& guiParameters, bool bLoadingPreset)
{
...
bool __stdcall CSimpleHPF::processAuxInputBus(audioProcessData* pAudioProcessData)
{
...
*/
bool __stdcall CSimpleHPF::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD, float fACMix, float fBDMix)
{
	// add your code here
...
/* processAudioBuffer
	...
	******************************
	...
	m_HostProcessInfo.uTimeSigDenomintor = Host Time Signature Denominator (if supported by host)
*/
bool __stdcall CSimpleHPF::processRackAFXAudioBuffer(float* pInputBuffer, float* pOutputBuffer,
...
*/
bool __stdcall CSimpleHPF::processVSTAudioBuffer(float** inBuffer, float** outBuffer, UINT uNumChannels, int inFramesToProcess)
{
...
bool __stdcall CSimpleHPF::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity)
{
	return true;
}

bool __stdcall CSimpleHPF::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff)
{
	return true;
}

// uModValue = 0->127
bool __stdcall CSimpleHPF::midiModWheel(UINT uChannel, UINT uModValue)
{
	return true;
}
...
bool __stdcall CSimpleHPF::midiPitchBend(UINT uChannel, int nActualPitchBendValue, float fNormalizedPitchBendValue)
{
	return true;
}
...
*/
bool __stdcall CSimpleHPF::midiClock()
{
...
bool __stdcall CSimpleHPF::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
*/
void CSimpleHPF::doVSTSampleAccurateParamUpdates()
{
...
void* __stdcall CSimpleHPF::showGUI(void* pInfo)
{
...
bool __stdcall CSimpleHPF::initUI()
{
	// ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! -------------------------------------- //
...
// **--0xDEA7--**
	...
	ui0->fUserDisplayDataHiLimit = 0.490000;
	...
	ui0->m_pUserCookedFloatData = &m_fSlider_a1;
	ui0->m_pUserCookedDoubleData = NULL;
	ui0->m_pUserCookedUINTData = NULL;
	ui0->cControlUnits = "";
	ui0->cVariableName = "m_fSlider_a1";
