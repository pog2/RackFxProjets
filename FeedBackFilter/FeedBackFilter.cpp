...
*/
CFeedBackFilter::~CFeedBackFilter(void)
{
...
*/
bool __stdcall CFeedBackFilter::initialize()
{
	// Add your code here
...
processRackAFXMessage()
	...
	See the website www.willpirkle.com for more details
*/
void __stdcall CFeedBackFilter::processRackAFXMessage(UINT uMessage, PROCESS_INFO& processInfo)
{
...
*/
bool __stdcall CFeedBackFilter::processAudioFrame(float* pInputBuffer, float* pOutputBuffer, UINT uNumInputChannels, UINT uNumOutputChannels)
{
	...
	// sauvegarde pour le passage n<-n+1
	m_f_z1_left = yn;
	pOutputBuffer[0] = yn;
	...
	if (uNumInputChannels == 2 && uNumOutputChannels == 2)
	{
		xn = pInputBuffer[1];
		yn_1 = m_f_z1_right;
		yn = m_f_a0_right*xn - m_f_b1_right*yn_1;
		m_f_z1_right = yn;
		pOutputBuffer[1] = yn;
	}
	return true;
...
//
bool __stdcall CFeedBackFilter::userInterfaceChange(int nControlIndex)
{
...
bool __stdcall CFeedBackFilter::checkUpdateGUI(int nControlIndex, float fValue, CLinkedList<GUI_PARAMETER>& guiParameters, bool bLoadingPreset)
{
...
bool __stdcall CFeedBackFilter::processAuxInputBus(audioProcessData* pAudioProcessData)
{
...
*/
bool __stdcall CFeedBackFilter::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD, float fACMix, float fBDMix)
{
	// add your code here
...
/* processAudioBuffer
	...
	******************************
	...
	m_HostProcessInfo.uTimeSigDenomintor = Host Time Signature Denominator (if supported by host)
*/
bool __stdcall CFeedBackFilter::processRackAFXAudioBuffer(float* pInputBuffer, float* pOutputBuffer,
...
*/
bool __stdcall CFeedBackFilter::processVSTAudioBuffer(float** inBuffer, float** outBuffer, UINT uNumChannels, int inFramesToProcess)
{
...
bool __stdcall CFeedBackFilter::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity)
{
	return true;
}

bool __stdcall CFeedBackFilter::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff)
{
	return true;
}

// uModValue = 0->127
bool __stdcall CFeedBackFilter::midiModWheel(UINT uChannel, UINT uModValue)
{
	return true;
}
...
bool __stdcall CFeedBackFilter::midiPitchBend(UINT uChannel, int nActualPitchBendValue, float fNormalizedPitchBendValue)
{
	return true;
}
...
*/
bool __stdcall CFeedBackFilter::midiClock()
{
...
bool __stdcall CFeedBackFilter::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
*/
void CFeedBackFilter::doVSTSampleAccurateParamUpdates()
{
...
void* __stdcall CFeedBackFilter::showGUI(void* pInfo)
{
...
bool __stdcall CFeedBackFilter::initUI()
{
	// ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! -------------------------------------- //
...
// **--0xDEA7--**
	...
	ui0->m_pUserCookedFloatData = &m_fSlider_a0;
	ui0->m_pUserCookedDoubleData = NULL;
	ui0->m_pUserCookedUINTData = NULL;
	ui0->cControlUnits = "";
	ui0->cVariableName = "m_fSlider_a0";
	...
	ui1->fInitUserFloatValue = 1.000000;
	ui1->fInitUserDoubleValue = 0;
	ui1->fInitUserUINTValue = 0;
	ui1->m_pUserCookedIntData = NULL;
	ui1->m_pUserCookedFloatData = &m_fSlider_b1;
	ui1->m_pUserCookedDoubleData = NULL;
	ui1->m_pUserCookedUINTData = NULL;
	ui1->cControlUnits = "";
	ui1->cVariableName = "m_fSlider_b1";
	ui1->cEnumeratedList = "SEL1,SEL2,SEL3";
	ui1->dPresetData[0] = 1.000000;ui1->dPresetData[1] = 0.000000;ui1->dPresetData[2] = 0.000000;ui1->dPresetData[3] = 0.000000;ui1->dPresetData[4] = 0.000000;ui1->dPresetData[5] = 0.000000;ui1->dPresetData[6] = 0.000000;ui1->dPresetData[7] = 0.000000;ui1->dPresetData[8] = 0.000000;ui1->dPresetData[9] = 0.000000;ui1->dPresetData[10] = 0.000000;ui1->dPresetData[11] = 0.000000;ui1->dPresetData[12] = 0.000000;ui1->dPresetData[13] = 0.000000;ui1->dPresetData[14] = 0.000000;ui1->dPresetData[15] = 0.000000;
	ui1->cControlName = "b1";
