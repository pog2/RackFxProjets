...
class CStereoLCRChorus : public CPlugIn
{
public:
	...
	//function to tranfer out variables & cook
	void updateModules();
	...
	float m_fModDepth_pct_L;
	float m_fModFrequency_Hz_L;
	float m_fFeedback__pct_L;
	float m_fModDepth_pct_C;
	float m_fModFrequency_Hz_C;
	float m_fFeedback__pct_C;
	float m_fModDepth_pct_R;
	float m_fModFrequency_Hz_R;
	float m_fFeedback__pct_R;
