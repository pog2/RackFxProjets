...
CResonnator::CResonnator()
{
	...
	m_f_thetac = 2*pi/44100*m_fSlider_fc;
	m_f_BW = m_fSlider_BW;

	m_f_b2_left = exp(-2*pi*m_f_BW/44100.0);
	m_f_b2_right = exp(-2*pi*m_f_BW/44100);

	m_f_b1_left = -4*m_f_b2_left/(1+m_f_b2_left)*cos(m_f_thetac);
	m_f_b1_right = -4*m_f_b2_right /(1+m_f_b2_right)*cos(m_f_thetac);

	m_f_a0_left = (1-m_f_b2_left)*sqrt(1-pow(m_f_b1_left,2)/(4* m_f_b2_left));
	m_f_a0_right = (1-m_f_b2_right)*sqrt(1-pow(m_f_b1_right,2)/(4*m_f_b2_right));
...
*/
bool __stdcall CResonnator::initialize()
{
	// Add your code here
...
processRackAFXMessage()
	...
	See the website www.willpirkle.com for more details
*/
void __stdcall CResonnator::processRackAFXMessage(UINT uMessage, PROCESS_INFO& processInfo)
{
...
*/
bool __stdcall CResonnator::prepareForPlay()
{
	// Add your code here:
	m_f_z2_left[0] = 0.0;
	m_f_z2_left[1] = 0.0;
...
*/
bool __stdcall CResonnator::processAudioFrame(float* pInputBuffer, float* pOutputBuffer, UINT uNumInputChannels, UINT uNumOutputChannels)
{
	...
	// (INSERT Effect)
	m_f_thetac = 2 * pi*m_f_fc / 44100;
	m_f_b2_left = exp(-2*pi*m_f_BW/44100);	
	m_f_b1_left = -4 * m_f_b2_left / (1 + m_f_b2_left)*cos(m_f_thetac);	
	m_f_a0_left = (1 - m_f_b2_left)*sqrt(1 - pow(m_f_b1_left, 2) / (4 * m_f_b2_left));
	

	float xn = pInputBuffer[0];
	float yn_1 = m_f_z2_left[0];
	float yn_2 = m_f_z2_left[1];
	float yn = m_f_a0_left*xn - m_f_b1_left*yn_1 - m_f_b2_left*yn_2;
...
//
bool __stdcall CResonnator::userInterfaceChange(int nControlIndex)
{
...
bool __stdcall CResonnator::checkUpdateGUI(int nControlIndex, float fValue, CLinkedList<GUI_PARAMETER>& guiParameters, bool bLoadingPreset)
{
...
bool __stdcall CResonnator::processAuxInputBus(audioProcessData* pAudioProcessData)
{
...
*/
bool __stdcall CResonnator::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD, float fACMix, float fBDMix)
{
	// add your code here
...
/* processAudioBuffer
	...
	******************************
	...
	m_HostProcessInfo.uTimeSigDenomintor = Host Time Signature Denominator (if supported by host)
*/
bool __stdcall CResonnator::processRackAFXAudioBuffer(float* pInputBuffer, float* pOutputBuffer,
...
*/
bool __stdcall CResonnator::processVSTAudioBuffer(float** inBuffer, float** outBuffer, UINT uNumChannels, int inFramesToProcess)
{
...
bool __stdcall CResonnator::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity)
{
	return true;
}

bool __stdcall CResonnator::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff)
{
	return true;
}

// uModValue = 0->127
bool __stdcall CResonnator::midiModWheel(UINT uChannel, UINT uModValue)
{
	return true;
}
...
bool __stdcall CResonnator::midiPitchBend(UINT uChannel, int nActualPitchBendValue, float fNormalizedPitchBendValue)
{
	return true;
}
...
*/
bool __stdcall CResonnator::midiClock()
{
...
bool __stdcall CResonnator::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
*/
void CResonnator::doVSTSampleAccurateParamUpdates()
{
...
void* __stdcall CResonnator::showGUI(void* pInfo)
{
...
bool __stdcall CResonnator::initUI()
{
	// ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! -------------------------------------- //
...
// **--0xDEA7--**
	...
	ui0->fUserDisplayDataHiLimit = 500.000000;
	ui0->uUserDataType = floatData;
	ui0->fInitUserIntValue = 0;
	ui0->fInitUserFloatValue = 0.200000;
	ui0->fInitUserDoubleValue = 0;
	ui0->fInitUserUINTValue = 0;
	ui0->m_pUserCookedIntData = NULL;
	ui0->m_pUserCookedFloatData = &m_fSlider_fc;
	ui0->m_pUserCookedDoubleData = NULL;
	ui0->m_pUserCookedUINTData = NULL;
	ui0->cControlUnits = "";
	ui0->cVariableName = "m_fSlider_fc";
	ui0->cEnumeratedList = "SEL1,SEL2,SEL3";
	ui0->dPresetData[0] = 0.200000;ui0->dPresetData[1] = 0.000000;ui0->dPresetData[2] = 0.000000;ui0->dPresetData[3] = 0.000000;ui0->dPresetData[4] = 0.000000;ui0->dPresetData[5] = 0.000000;ui0->dPresetData[6] = 0.000000;ui0->dPresetData[7] = 0.000000;ui0->dPresetData[8] = 0.000000;ui0->dPresetData[9] = 0.000000;ui0->dPresetData[10] = 0.000000;ui0->dPresetData[11] = 0.000000;ui0->dPresetData[12] = 0.000000;ui0->dPresetData[13] = 0.000000;ui0->dPresetData[14] = 0.000000;ui0->dPresetData[15] = 0.000000;
	ui0->cControlName = "fc";
	...
	ui1->fInitUserFloatValue = 10.000000;
	ui1->fInitUserDoubleValue = 0;
	ui1->fInitUserUINTValue = 0;
	ui1->m_pUserCookedIntData = NULL;
	ui1->m_pUserCookedFloatData = &m_fSlider_BW;
	ui1->m_pUserCookedDoubleData = NULL;
	ui1->m_pUserCookedUINTData = NULL;
	ui1->cControlUnits = "";
	ui1->cVariableName = "m_fSlider_BW";
	ui1->cEnumeratedList = "SEL1,SEL2,SEL3";
	ui1->dPresetData[0] = 10.000000;ui1->dPresetData[1] = 0.000000;ui1->dPresetData[2] = 0.000000;ui1->dPresetData[3] = 0.000000;ui1->dPresetData[4] = 0.000000;ui1->dPresetData[5] = 0.000000;ui1->dPresetData[6] = 0.000000;ui1->dPresetData[7] = 0.000000;ui1->dPresetData[8] = 0.000000;ui1->dPresetData[9] = 0.000000;ui1->dPresetData[10] = 0.000000;ui1->dPresetData[11] = 0.000000;ui1->dPresetData[12] = 0.000000;ui1->dPresetData[13] = 0.000000;ui1->dPresetData[14] = 0.000000;ui1->dPresetData[15] = 0.000000;
	ui1->cControlName = "BandW";
