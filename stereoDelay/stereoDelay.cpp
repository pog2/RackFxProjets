...
{
	//forward variables to member object
	m_DDL_Left.m_fDelay_ms = m_fDelay_ms;
	m_DDL_Right.m_fDelay_ms = m_fDelay_ms;

	m_DDL_Left.m_f_FeedBack_pct = m_f_Feedback_pct;
	m_DDL_Right.m_f_FeedBack_pct = m_f_Feedback_pct;
...
*/
CstereoDelay::~CstereoDelay(void)
{
...
*/
bool __stdcall CstereoDelay::initialize()
{
	// Add your code here
...
processRackAFXMessage()
	...
	See the website www.willpirkle.com for more details
*/
void __stdcall CstereoDelay::processRackAFXMessage(UINT uMessage, PROCESS_INFO& processInfo)
{
...
*/
bool __stdcall CstereoDelay::processAudioFrame(float* pInputBuffer, float* pOutputBuffer, UINT uNumInputChannels, UINT uNumOutputChannels)
{
	...
	// (INSERT Effect)
	//forward call to sub_object : pInput, pOutput, 1 input ch, 1 output ch
	switch (m_uDelayType)
	{
	case CROSS:
		//Cross fb delay
		...
		//Debug 
		float feedback;
		feedback = m_DDL_Right.getCurrentFeedback();
		//</debug>
		m_DDL_Left.setCurrentFeedbackInput(m_DDL_Right.getCurrentFeedback());
		m_DDL_Right.setCurrentFeedbackInput(m_DDL_Left.getCurrentFeedback());
		break;
	...
	if (uNumInputChannels == 2 && uNumOutputChannels == 2)
		//forward call to subobject (right)
...
-------------------------------------------------------------------
0				m_fDelay_ms                       0
1				m_f_Feedback_pct                  1
2				m_f_WetLevel_pct                  2
3				m_uDelayType                      3
...
bool __stdcall CstereoDelay::checkUpdateGUI(int nControlIndex, float fValue, CLinkedList<GUI_PARAMETER>& guiParameters, bool bLoadingPreset)
{
...
bool __stdcall CstereoDelay::processAuxInputBus(audioProcessData* pAudioProcessData)
{
...
*/
bool __stdcall CstereoDelay::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD, float fACMix, float fBDMix)
{
	// add your code here
...
/* processAudioBuffer
	...
	******************************
	...
	m_HostProcessInfo.uTimeSigDenomintor = Host Time Signature Denominator (if supported by host)
*/
bool __stdcall CstereoDelay::processRackAFXAudioBuffer(float* pInputBuffer, float* pOutputBuffer,
...
*/
bool __stdcall CstereoDelay::processVSTAudioBuffer(float** inBuffer, float** outBuffer, UINT uNumChannels, int inFramesToProcess)
{
...
bool __stdcall CstereoDelay::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity)
{
	return true;
}

bool __stdcall CstereoDelay::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff)
{
	return true;
}

// uModValue = 0->127
bool __stdcall CstereoDelay::midiModWheel(UINT uChannel, UINT uModValue)
{
	return true;
}
...
bool __stdcall CstereoDelay::midiPitchBend(UINT uChannel, int nActualPitchBendValue, float fNormalizedPitchBendValue)
{
	return true;
}
...
*/
bool __stdcall CstereoDelay::midiClock()
{
...
bool __stdcall CstereoDelay::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
*/
void CstereoDelay::doVSTSampleAccurateParamUpdates()
{
...
void* __stdcall CstereoDelay::showGUI(void* pInfo)
{
...
bool __stdcall CstereoDelay::initUI()
{
	// ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! -------------------------------------- //
...
// **--0xDEA7--**
	...
	ui0->fInitUserFloatValue = 200.000000;
	...
	ui1->m_pUserCookedFloatData = &m_f_Feedback_pct;
	ui1->m_pUserCookedDoubleData = NULL;
	ui1->m_pUserCookedUINTData = NULL;
	ui1->cControlUnits = "%";
	ui1->cVariableName = "m_f_Feedback_pct";
	...
	ui2->m_pUserCookedFloatData = &m_f_WetLevel_pct;
	ui2->m_pUserCookedDoubleData = NULL;
	ui2->m_pUserCookedUINTData = NULL;
	ui2->cControlUnits = "%";
	ui2->cVariableName = "m_f_WetLevel_pct";
	ui2->cEnumeratedList = "SEL1,SEL2,SEL3";
	ui2->dPresetData[0] = 50.000000;ui2->dPresetData[1] = 0.000000;ui2->dPresetData[2] = 0.000000;ui2->dPresetData[3] = 0.000000;ui2->dPresetData[4] = 0.000000;ui2->dPresetData[5] = 0.000000;ui2->dPresetData[6] = 0.000000;ui2->dPresetData[7] = 0.000000;ui2->dPresetData[8] = 0.000000;ui2->dPresetData[9] = 0.000000;ui2->dPresetData[10] = 0.000000;ui2->dPresetData[11] = 0.000000;ui2->dPresetData[12] = 0.000000;ui2->dPresetData[13] = 0.000000;ui2->dPresetData[14] = 0.000000;ui2->dPresetData[15] = 0.000000;
	...
	ui3->m_pUserCookedUINTData = &m_uDelayType;
	ui3->cControlUnits = "";
	ui3->cVariableName = "m_uDelayType";
	ui3->cEnumeratedList = "NORM,CROSS";
