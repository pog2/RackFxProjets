...
void CResonantLPF::calculateLPFCoeffs(float fCutoffFreq, float fQ)
{
	//
...
*/
CResonantLPF::~CResonantLPF(void)
{
...
*/
bool __stdcall CResonantLPF::initialize()
{
	// Add your code here
...
processRackAFXMessage()
	...
	See the website www.willpirkle.com for more details
*/
void __stdcall CResonantLPF::processRackAFXMessage(UINT uMessage, PROCESS_INFO& processInfo)
{
...
*/
bool __stdcall CResonantLPF::processAudioFrame(float* pInputBuffer, float* pOutputBuffer, UINT uNumInputChannels, UINT uNumOutputChannels)
{
...
bool __stdcall CResonantLPF::checkUpdateGUI(int nControlIndex, float fValue, CLinkedList<GUI_PARAMETER>& guiParameters, bool bLoadingPreset)
{
...
bool __stdcall CResonantLPF::processAuxInputBus(audioProcessData* pAudioProcessData)
{
...
*/
bool __stdcall CResonantLPF::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD, float fACMix, float fBDMix)
{
	// add your code here
...
/* processAudioBuffer
	...
	******************************
	...
	m_HostProcessInfo.uTimeSigDenomintor = Host Time Signature Denominator (if supported by host)
*/
bool __stdcall CResonantLPF::processRackAFXAudioBuffer(float* pInputBuffer, float* pOutputBuffer,
...
*/
bool __stdcall CResonantLPF::processVSTAudioBuffer(float** inBuffer, float** outBuffer, UINT uNumChannels, int inFramesToProcess)
{
...
bool __stdcall CResonantLPF::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity)
{
	return true;
}

bool __stdcall CResonantLPF::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff)
{
	return true;
}

// uModValue = 0->127
bool __stdcall CResonantLPF::midiModWheel(UINT uChannel, UINT uModValue)
{
	return true;
}
...
bool __stdcall CResonantLPF::midiPitchBend(UINT uChannel, int nActualPitchBendValue, float fNormalizedPitchBendValue)
{
	return true;
}
...
*/
bool __stdcall CResonantLPF::midiClock()
{
...
bool __stdcall CResonantLPF::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
*/
void CResonantLPF::doVSTSampleAccurateParamUpdates()
{
...
void* __stdcall CResonantLPF::showGUI(void* pInfo)
{
...
bool __stdcall CResonantLPF::initUI()
{
	// ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! -------------------------------------- //
...
// **--0xDEA7--**
	...
	ui0->fUserDisplayDataHiLimit = 5000.000000;
