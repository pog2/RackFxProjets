...
*/
bool __stdcall Cbypass::initialize()
{
	// Add your code here
...
processRackAFXMessage()
	...
	See the website www.willpirkle.com for more details
*/
void __stdcall Cbypass::processRackAFXMessage(UINT uMessage, PROCESS_INFO& processInfo)
{
...
*/
bool __stdcall Cbypass::prepareForPlay()
{
	// Add your code here:
...
*/
bool __stdcall Cbypass::processAudioFrame(float* pInputBuffer, float* pOutputBuffer, UINT uNumInputChannels, UINT uNumOutputChannels)
{
...
//
bool __stdcall Cbypass::userInterfaceChange(int nControlIndex)
{
...
bool __stdcall Cbypass::checkUpdateGUI(int nControlIndex, float fValue, CLinkedList<GUI_PARAMETER>& guiParameters, bool bLoadingPreset)
{
...
bool __stdcall Cbypass::processAuxInputBus(audioProcessData* pAudioProcessData)
{
...
*/
bool __stdcall Cbypass::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD, float fACMix, float fBDMix)
{
	// add your code here
...
/* processAudioBuffer
	...
	******************************
	...
	m_HostProcessInfo.uTimeSigDenomintor = Host Time Signature Denominator (if supported by host)
*/
bool __stdcall Cbypass::processRackAFXAudioBuffer(float* pInputBuffer, float* pOutputBuffer,
...
*/
bool __stdcall Cbypass::processVSTAudioBuffer(float** inBuffer, float** outBuffer, UINT uNumChannels, int inFramesToProcess)
{
...
bool __stdcall Cbypass::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity)
{
	return true;
}

bool __stdcall Cbypass::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff)
{
	return true;
}

// uModValue = 0->127
bool __stdcall Cbypass::midiModWheel(UINT uChannel, UINT uModValue)
{
	return true;
}
...
bool __stdcall Cbypass::midiPitchBend(UINT uChannel, int nActualPitchBendValue, float fNormalizedPitchBendValue)
{
	return true;
}
...
*/
bool __stdcall Cbypass::midiClock()
{
...
bool __stdcall Cbypass::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
*/
void Cbypass::doVSTSampleAccurateParamUpdates()
{
...
void* __stdcall Cbypass::showGUI(void* pInfo)
{
